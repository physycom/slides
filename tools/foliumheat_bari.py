...
def generateBaseMap(default_location=[41.11148, 16.8554], default_zoom_start=12):
  base_map = folium.Map(location=default_location, control_scale=True, zoom_start=default_zoom_start)
  return base_map

df = pd.read_csv('/var/www/html/symfony4/Bari/Streets/slides_bari2.csv', sep=',')
print(df)
...
if 0:
  ...
  base_map.save('/var/www/html/symfony4/public/f/foliumheat_bari.html')
...
if 1:
  ...
  base_map.save('/var/www/html/symfony4/public/f/foliumaniheat_bari.html')
